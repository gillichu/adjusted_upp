...
#                       decomp_strategy='normal', pdistance=1, distances=None):
    def decompose_tree(self, maxSize, strategy, minSize=None, tree_map={},
        ...
        #_LOG.info("decomp_strategy: %s" % str(decomp_strategy))
        #_LOG.info("strategy: %s " % str(strategy))
        #_LOG.info("Size Info: " + str(self.count_leaves()) + ", " + str(maxSize))
        #_LOG.info("pdistance: %s" % pdistance)    
