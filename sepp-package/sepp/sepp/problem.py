...
class SeppProblem(Problem):
    ...
    def read_extendend_alignment_and_relabel_columns(
        ...
        _LOG.info("<read_extendend_alignment_and_relabel_columns()> num cols is %s" % str(ap_alg.get_length()))
        _LOG.info("Here is extendedAlignment %s" % ap_alg.get_sequence_names())
        ap_alg.write_to_path("/Users/gillianchu/warnow/bin/gitrepos/smirarab-sepp-17a33aa/trial/extension.txt")
